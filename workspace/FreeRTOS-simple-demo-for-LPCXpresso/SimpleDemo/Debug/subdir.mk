...
%.o: ../%.c
	...
	arm-none-eabi-gcc -DDEBUG -D__USE_CMSIS=CMSISv1p30_LPC17xx -D__CODE_RED -I"C:\E\Dev\workspaces\LPCXpresso\SimpleDemo" -I"C:\E\Dev\workspaces\LPCXpresso\CMSISv1p30_LPC17xx\inc" -I"C:\E\Dev\workspaces\LPCXpresso\FreeRTOS_Library\include" -I"C:\E\Dev\workspaces\LPCXpresso\FreeRTOS_Library\portable" -O0 -g3 -fsigned-char -c -fmessage-length=0 -fno-builtin -ffunction-sections -mcpu=cortex-m3 -mthumb -D__REDLIB__ -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o"$@" "$<"
