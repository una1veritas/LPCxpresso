...
Note: The MCU initialization code (NOT the C startup code) is
in the file system_LPC13xx.c. All of the peripheral clock and
main PLL settings are also #defined here and shared by all of
